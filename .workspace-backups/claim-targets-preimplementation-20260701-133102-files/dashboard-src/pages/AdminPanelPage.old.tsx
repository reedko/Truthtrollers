              ...
              <Card bg="rgba(0, 229, 255, 0.05)" borderColor="cyan.400" borderWidth="1px">
                <CardHeader>
                  ...
                  <Text fontSize="sm" color="gray.400" mt={2}>
                    Controls how the evidence engine searches for sources to verify claims
                  </Text>
                </CardHeader>
                <CardBody>
                  <VStack spacing={6} align="stretch">
                    {/* Mode Selector */}
                    <Box>
                      <Text fontWeight="bold" mb={2} color="cyan.300">
                        Current Search Mode:
                      </Text>
                      <Select
                        value={evidenceMode}
                    ...
                    {/* Mode Descriptions */}
                    <Box p={4} bg="rgba(0, 229, 255, 0.1)" borderRadius="md" borderWidth="1px" borderColor="cyan.700">
                      <VStack align="start" spacing={4}>
                        <Text fontWeight="bold" color="cyan.300" fontSize="lg">Mode Details:</Text>

                        <Box pl={3} borderLeft="3px solid" borderColor="green.500">
                          <Text fontWeight="semibold" color="green.300">Mode 1: High Quality Only</Text>
                          <Text fontSize="sm" color="gray.300" mt={1}>
                            <strong>Best for:</strong> Fast, reliable fact-checking from authoritative sources
                          </Text>
                          <Text fontSize="sm" color="gray.400" mt={1}>
                            • <strong>Sources:</strong> Tavily + Bing only (curated high-quality)<br/>
                            • <strong>Queries:</strong> 4 per claim<br/>
                            • <strong>Max sources:</strong> 3 evidence candidates per claim<br/>
                            • <strong>Speed:</strong> Fastest mode<br/>
                            • <strong>Use case:</strong> Quick verification from mainstream/authoritative sources
                          </Text>
                        </Box>

                        <Box pl={3} borderLeft="3px solid" borderColor="cyan.500">
                          <Text fontWeight="semibold" color="cyan.300">Mode 2: Fringe on Support (Default)</Text>
                          <Text fontSize="sm" color="gray.300" mt={1}>
                            <strong>Best for:</strong> Finding counter-evidence when mainstream sources agree
                          </Text>
                          <Text fontSize="sm" color="gray.400" mt={1}>
                            • <strong>Sources:</strong> Tavily + Bing, then alternative sources when triggered<br/>
                            • <strong>Queries:</strong> 4 per claim (+ 2 fringe if triggered)<br/>
                            • <strong>Max sources:</strong> 3 high-quality (+ 2 fringe if triggered)<br/>
                            • <strong>Trigger:</strong> When support confidence {">"} 70%, search fringe sources<br/>
                            • <strong>Speed:</strong> Medium<br/>
                            • <strong>Use case:</strong> Balance speed with finding dissenting opinions
                          </Text>
                        </Box>

                        <Box pl={3} borderLeft="3px solid" borderColor="purple.500">
                          <Text fontWeight="semibold" color="purple.300">Mode 3: Balanced All Claims</Text>
                          <Text fontSize="sm" color="gray.300" mt={1}>
                            <strong>Best for:</strong> Deep investigation with diverse perspectives
                          </Text>
                          <Text fontSize="sm" color="gray.400" mt={1}>
                            • <strong>Sources:</strong> Tavily + Bing with balanced query strategies<br/>
                            • <strong>Queries:</strong> 6 per claim (2 support + 2 refute + 2 nuance)<br/>
                            • <strong>Max sources:</strong> 6 evidence candidates per claim<br/>
                            • <strong>Balance:</strong> Actively seeks supporting, refuting, and contextual evidence<br/>
                            • <strong>Speed:</strong> Slowest, most comprehensive<br/>
                            • <strong>Use case:</strong> Thorough fact-checking requiring multiple viewpoints
                          </Text>
                        </Box>
                      </VStack>
                    </Box>
                    ...
                    <Box p={3} bg="rgba(255, 165, 0, 0.1)" borderRadius="md" borderWidth="1px" borderColor="orange.500">
                    ...
                    <Box p={3} bg="rgba(113, 219, 255, 0.05)" borderRadius="md" borderWidth="1px" borderColor="cyan.700">
                      <Text fontSize="sm" color="gray.300" fontWeight="semibold" mb={2}>
                        Additional Configuration:
                      </Text>
                      <Text fontSize="sm" color="gray.400">
                        • <strong>Max claims per article:</strong> 12 (set in llm_prompts table)<br/>
                        • <strong>Min sources per claim:</strong> 2 (set in llm_prompts table)<br/>
                        • <strong>Max sources per claim:</strong> 4 (set in llm_prompts table)<br/>
                        • <strong>Extraction mode:</strong> Ranked (extracts top-quality claims only)
                      </Text>
                      <Text fontSize="xs" color="gray.500" mt={2}>
                        See backend/SCRAPE_AND_EVIDENCE_WORKFLOW.md for full documentation
                      </Text>
                    </Box>

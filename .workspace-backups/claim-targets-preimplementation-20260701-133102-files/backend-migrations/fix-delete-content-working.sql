-- Fix delete_content_cascade with a working approach
-- Uses derived tables to avoid MySQL subquery limitations
...
BEGIN
    ...
    -- Step 6: Delete content_claims links
    ...
    -- Step 13: Delete molecule view records
    DELETE FROM molecule_views WHERE content_id = content_id_to_delete;

    -- Step 14: Delete discussion entries
...
SELECT '✅ Stored procedure fixed with derived tables' AS status;

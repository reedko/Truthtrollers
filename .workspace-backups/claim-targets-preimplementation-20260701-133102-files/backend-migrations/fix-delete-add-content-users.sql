-- Fix delete_content_cascade to handle content_users table
-- Add deletion of content_users before deleting content
...
BEGIN
    ...
    -- Step 15: Delete content_users (user assignments to content) ← NEW!
...
SELECT '✅ Stored procedure updated: delete_content_cascade now handles content_users' AS status;

  ...
  return {
    ...
    entities: {
      ...
      publication_venue: entity(
        ...
        venueMethod,
        venueConfidence,
        { venue_type: hostIdentity && venue === hostIdentity.venue ? "other" : "journal", evidence: venueEvidence || venue },
      ),
    },
    context: {
      ...
      venue_name: venue,
      venue_type: venue ? (hostIdentity && venue === hostIdentity.venue ? "other" : "journal") : null,
      source_alignment: hostIdentity ? {
        type: "educational_institution",
        marker: "EDU",
        label: "Educational institution",
        scope: "organizational",
        confidence: hostIdentity.confidence,
        method: hostIdentity.method,
        explanation: `Hosted and published by ${hostIdentity.organization}.`,
        evidence: [hostIdentity.evidence],
      } : null,
      article_type: articleType,
      publication_date: publicationDate,
      volume,

...
test("DROP_STAGES exposes a stable pre_bearing stage name for audits", () => {
  assert.equal(DROP_STAGES.PRE_BEARING, "pre_bearing");
  assert.equal(DROP_STAGES.POOL, "pool");
  assert.equal(DROP_STAGES.LLM_BEARING, "llm_bearing");
});

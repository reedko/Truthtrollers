...
import { registerReferenceClaimRoutes } from "./referenceClaimRoutes.js";
...
import contentRouter from "../src/routes/content/index.js";
...
// ───────────────────────────────────────────────────────────
app.use("/", authRouter);           // Auth routes: /api/register, /api/login, etc.
app.use("/", usersRouter);          // User routes: /api/all-users, /api/change-email, etc.
app.use("/", contentRouter);        // Content routes: /api/content, /api/tasks, etc.

...
export default function ({ query, pool }) {
  ...
  router.delete(
    ...
    async (req, res) => {
      ...
      console.log(
        `[DELETE CONTENT] Request from user ${userId} to delete content ${contentId}`,
      );
      ...
      `,
        ...
        console.log(
          `[DELETE CONTENT] User ${userId} is super_admin, proceeding with deletion...`,
        );
        ...
        if (includeReferences) {
          console.log(
            `[DELETE CONTENT] Full delete: removing task ${contentId} AND all linked references`,
          );
        ...
        console.log(
          `[DELETE CONTENT] Successfully deleted content ${contentId}`,
        );

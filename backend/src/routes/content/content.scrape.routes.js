...
import { processEvidenceBearingResults } from "../../core/processEvidenceBearingResults.js";
    ...
    try {
      ...
      if (refPublisherName && refPublisherName !== "Unknown Publisher") {
        try {
          ...
          // Preserve the normalized wrapper, venue, parent, and recursively
          // resolved original-publisher roles instead of flattening to a name.
          await persistPublishers(query, referenceContentId, scrapeResult.publisher);
          logger.log(

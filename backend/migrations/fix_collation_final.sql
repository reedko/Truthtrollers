-- Final collation fix with correct FK names
-- Step 1: Drop the two foreign keys
...
-- Step 4: Recreate both foreign keys
ALTER TABLE ttlive_imported_posts
...
SELECT '✅ Collation fixed - all columns now utf8mb4_unicode_ci' AS status;

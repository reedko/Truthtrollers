-- Fix delete_content_cascade to handle discussion_entries table
-- Add deletion of discussion entries before deleting content
...
SELECT '✅ Stored procedure updated: delete_content_cascade now handles discussion_entries' AS status;

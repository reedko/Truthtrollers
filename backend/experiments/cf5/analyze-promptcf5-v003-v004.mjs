#!/usr/bin/env node
// CF5 PromptCF5-v0003/v0004 blind regression — analysis pass. Reuses
// targetMatching.js and regressionAnalysis.js unmodified (no code changes, per this
// experiment's constraints). Only 1 repeat per fixture per version — exactTextStability
// and targetBasedStability naturally degrade to "not computable" / "single-run
// presence" respectively when given a single repeat; this is not special-cased, it is
// the existing functions' honest behavior with n=1.

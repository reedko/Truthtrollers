...
export const CaseFocusPage: React.FC = () => {
  ...
  const sharedCardMinH =
    useBreakpointValue({
      base: "400px",
      xl: "600px",
    }) ?? "400px";

  const sharedCardWidthProps = {
    w: `${sharedCardWidth}px`,
    minW: `${sharedCardWidth}px`,
    maxW: `${sharedCardWidth}px`,
    flexShrink: 0,
  };

  const sharedTrackOffset = `calc(50% - ${sharedCardWidth / 2}px)`;
  const sharedTrackStep = sharedCardWidth + sharedCardGap;
                ...
                >
                  {focusClaim && (
                    ...
                    <>
                      ...
                      {/* TEMP REMOVED TO TEST WIDTH
                      <HStack
                        justify="space-between"
                        align="center"
                        h="28px"
                        mt="0"
                        ml={styleMode === "mr1" ? "16px" : "0"}
                      >
                        <Button
                          fontSize="11px"
                          fontWeight="600"
                        ...
                        */}
                        ...
                        >
                          ...
                          >
                            {getCurvedEdge("red")}
                            <Text
                              fontSize={{ base: "6px", xl: "11px" }}
                              textTransform="uppercase"
                              letterSpacing={{ base: "0.01em", xl: "0.09em" }}
                              color="#ff6c88"
                              position="relative"
                              zIndex={1}
                ...
                >
                  ...
                  >
                    <Flex
                      ...
                      transform={`translateX(calc(${sharedTrackOffset} - ${currentCandidateIndex * sharedTrackStep}px))`}
                      justifyContent="flex-start"
                    >
                      {candidates.map((candidate, idx) => (
                        ...
                        >
                          ...
                          <VStack align="stretch" spacing={3}>
                              ...
                              <Badge
                                ...
                                {...(styleMode === "mr1"
                                  ? {
                                      ...
                                      borderColor: "rgba(113, 219, 255, 0.3)",
                                      boxShadow:
                                        "0 4px 12px rgba(0, 0, 0, 0.3), 0 0 15px rgba(113, 219, 255, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.1)",
                                      _hover: {
                                        transform:
                                          "translateY(-1px) translateZ(0)",
                                        boxShadow:
                                          "0 6px 16px rgba(0, 0, 0, 0.4), 0 0 20px rgba(113, 219, 255, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.15)",
                                      },
                                    }
                                  : {
                                      bg: "linear-gradient(180deg, rgba(113, 219, 255, 0.18), rgba(113, 219, 255, 0.08))",
                            ...
                            >
                              <Box
                                borderRadius={{ base: "12px", xl: "18px" }}
                                {...getBoxStyle("red")}
                                p={{ base: 1, xl: 3 }}
                                minH={{ base: "40px", xl: "72px" }}
                                maxW="100%"
                                position="relative"
                                overflow={{ base: "hidden", xl: "visible" }}
                                transform="translateZ(0)"
